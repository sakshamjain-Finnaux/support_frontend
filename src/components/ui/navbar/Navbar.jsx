    ...
    return (
        <header className="w-full">
            <nav className="border-b border-body-800 h-[54px] bg-body-900 px-6 flex items-center justify-between">
                <button onClick={() => setIsSidebarOpen(state => !state)} className="text-xl hover:bg-body-800 rounded-lg p-2 active:text-primary-600">
                    {
                        isSidebarOpen ?
                            <SidebarCloseIcon />
                            :
                ...
                <div className="flex gap-4 items-center">
                    ...
                    <Popover as="div" className="relative inline-block text-left">
                        {({ open }) => (
                            <>
                                <Popover.Button as="button" className={`p-2 hover:bg-body-800 rounded-lg ${open ? "text-primary-600 bg-body-800" : ""}`}>
                                    <BellIcon />
                                </Popover.Button>
                                <Transition
                                    as={Fragment}
                        ...
                        {({ open }) => (
                            <CustomFloat>
                                ...
                                <Transition
                                    ...
                                    leaveTo="transform opacity-0 scale-95"
                                >
                                    <Menu.Items className="w-32 origin-top-right divide-y divide-body-700 py-1 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none bg-body-940 z-50 text-xs border border-body-800">

                                        <Menu.Item
                                            as="button"
                                            onClick={signout}
                                            className={`w-full py-1 cursor-pointer font-semibold flex items-center justify-center text-red-600 hover:bg-body-800`}
                                        >
                                            Signout
                                        </Menu.Item>
                                    </Menu.Items>
