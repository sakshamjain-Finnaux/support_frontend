...
const controlStyles = {
    ...
    focus: "ring-1 ring-offset-1 ring-opacity-50 ring-offset-transparent ring-primary-800",
...
export default function SelectField({ disabled = false, placeholder = "Select...", control, isMulti = false, options, name, rules = {}, title, isLoading = false, defaultValue = null, formatOptionLabel = null, isClearable = false }) {
    return (
                    ...
                    <div className="w-full relative">
                        <label className="block">
                            ...
                            <Select
                                ...
                                components={{ DropdownIndicator, ClearIndicator, MultiValueRemove, ValueContainer }}
                                classNames={{
                                    control: ({ isFocused, isDisabled }) =>
                                        clsx(
                                            error && "!border-red-700 !ring-red-800 hover:!border-red-900", isFocused ? controlStyles.focus : controlStyles.nonFocus, isDisabled && "!bg-body-700",
                                            controlStyles.base,
                                        ),
