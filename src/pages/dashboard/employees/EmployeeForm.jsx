...
export default function EmployeeForm({ formData, submitMutation, type, resetPassword = null, inactiveCallback = null }) {
    const { register, setValue, control, unregister, formState: { errors }, handleSubmit } = formData ? useForm({
        defaultValues: {
            ...formData
        }
    }) : useForm();
    ...
    return (
        ...
        <form onSubmit={handleSubmit(submitMutation.mutate)} className="flex flex-wrap gap-4 bg-body-800 bg-opacity-40 p-4 rounded-lg border-body-700 border justify-between">
            ...
            <>
                ...
                <div className="flex w-full items-center justify-between gap-6">
                    ...
                    <ProfileField control={control} register={register} setValue={setValue} />
            ...
            <>
                ...
                <div className="w-full ms:w-[45%] md:w-[30%]">
                    <InputField
                        ...
                        validationSchema={{
                            required: "Address is required!",
                            validate: (value) => !!value.trim() || "Beneficiary Name is required!"
                        }}
                    />
                </div>
                ...
                <div className="w-full ms:w-[45%] md:w-[30%]">
                    <InputField
                        ...
                        validationSchema={{
                            ...
                            validate: (value) => !!value.trim() || "Account Number is required!"
                        }}
                    />
                </div>
            ...
            <>
                ...
                {type === "edit" || <div className="w-full ms:w-[45%] md:w-[30%]">
        ...
        <div className="w-full ms:w-[45%] md:w-[30%]">
            <SelectField
                ...
                formatOptionLabel={(option) => (
                    < span className=''>
                        <div div className='capitalize' > {option.label}</div>
...
function OldEmployeeSubordinatesField({ control, unregister, options, selectedOptions }) {
    ...
    return (
        <div className="flex min-w-[18%] max-w-[18%] h-full items-center justify-center  flex-col gap-1">
            ...
            <div className="my-auto flex w-full h-[82%] flex-col border-body-700  border-4 border-dotted items-center justify-center overflow-hidden">
                <label title="profile photo" className="p-1 cursor-pointer h-full flex items-center justify-center">
                    <input
                        accept="image/*"
                        type="file"
                        ...
                        (
                            <div className="relative h-full w-full flex items-center justify-center">
                                ...
                                <button
                                    ...
                                    title="remove image" className="absolute w-4 h-4 text-sm flex items-center justify-center top-0 right-0 bg-red-800 rounded-sm p-2 text-red-200 z-50">
                                    X
                                </button>
                            </div>
                        )
...
function PermanentFields({ control, register, errors, setValue }) {
    const fields = ["address", "landmark", "pincode", "state", "district", "tehsil"];
        ...
        <>
            <div className="w-full mt-4">
                ...
                <div className="flex gap-2 items-center mt-2 text-sm">
                    ...
                    />
                    <span className="text-body-400 text-base font-medium">Same as Present Address ?</span>
                </div>
            </div>
            <div className="w-full ms:w-[45%] md:w-[30%]">
                <InputField
