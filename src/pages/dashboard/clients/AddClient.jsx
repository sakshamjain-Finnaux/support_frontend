...
export default function AddClient({ formData }) {
    const { register, watch, setValue, control, formState: { errors }, handleSubmit } = formData ? useForm({
        defaultValues: {
            ...formData
        }
    }) : useForm();
    ...
    return (
        <div className="flex-grow gap-6 flex flex-col">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-wrap gap-4 bg-body-800 bg-opacity-40 p-4 rounded-lg border-body-700 border justify-between">
    ...
    return (
        <div className="flex min-w-[18%] max-w-[18%] items-center justify-center flex-col gap-1 min-h-[16rem] max-h-[16rem]">
            ...
            <div className="my-auto flex w-full h-[82%] flex-col border-body-700  border-4 border-dotted items-center justify-center overflow-hidden">
                <label title="company logo" className="p-1 cursor-pointer h-full flex items-center justify-center">
                    <input
                        accept="image/*"
                        type="file"
