...
export default function ClientsPendingIssues() {
  ...
  const query = useQuery({
    queryKey: ["issues", "clients", "pending", queryPageIndex, queryPageSize],
    queryFn: fetchData.bind(null, queryPageIndex, queryPageSize),
  });

  async function fetchData(pageIndex, pageSize) {
    const result = await networkRequest("clients_pending_issues", {
      pageIndex,
      pageSize,
    });
