...
export default function ClientsAssignedIssues() {
    ...
    async function fetchData(pageIndex, pageSize) {
        const result = await networkRequest("clients_assigned_issues", { pageIndex, pageSize });
        if (!result.success) throw result;
        return result.data;
    }

    const query = useQuery({
        queryKey: ["issues", "clients", "assigned", queryPageIndex, queryPageSize],
