...
import { AlertCircle, Check, ChevronsUpDown, Plus, X } from "lucide-react";
            ...
            <div
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                {show.priority && (
                  <div className="space-y-1">
                    <Label className="text-[10px] font-semibold text-body-500 uppercase">
                      Priority
                    </Label>
                    <Controller
                      control={control}
                    ...
                    {errors?.assignments?.[user.emp_id]?.priority && (
                      <p className="text-[10px] text-red-500">
                        {errors.assignments[user.emp_id].priority.message}
                      </p>
                    )}
                  </div>
                )}
                ...
                {show.target_date && (
                  <div className="space-y-1">
                    ...
                    {errors?.assignments?.[user.emp_id]?.target_date && (
                      <p className="text-[10px] text-red-500">
                        {errors.assignments[user.emp_id].target_date.message}
                      </p>
                    )}
                  </div>
                )}
              ...
              <div className="space-y-1">
                ...
                {errors?.assignments?.[user.emp_id]?.msg && (
                  <p className="text-[10px] text-red-500">
                    {errors.assignments[user.emp_id].msg.message}
                  </p>
                )}
              </div>
            </div>
          ...
          {!isAdding ? (
            ...
            <div className="col-span-1 sm:col-span-2 rounded-lg border border-body-800 bg-body-900/20 p-3 animate-in fade-in zoom-in-95 duration-200">
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs font-medium text-body-400">
                  Select Person
                </span>
                <button
                  type="button"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <Combobox
                  ...
                  options={subOrdinatesOptions.filter(
                    (o) => !assignedIds.includes(o.emp_id),
                  )}
                  placeholder={
                    designationValue
                      ? "Select Person..."
...
function Combobox({
  ...
  const selected = options.find(
    (o) =>
      o.value?.toString().toLowerCase() === value?.toString().toLowerCase(),
  );
