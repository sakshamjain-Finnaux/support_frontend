...
export default function CompanyRevertedIssues() {
    ...
    async function fetchData(pageIndex, pageSize) {
        const result = await networkRequest("finnaux_reverted_issues", { pageIndex, pageSize });
        if (!result.success) throw result;
        return result.data;
    }

    const query = useQuery({
        queryKey: ["issues", "finnaux", "reverted", queryPageIndex, queryPageSize],
