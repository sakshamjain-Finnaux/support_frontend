...
export default function CompanyInProgressIssues() {
    ...
    async function fetchData(pageIndex, pageSize) {
        const result = await networkRequest("finnaux_inprogress_issues", { pageIndex, pageSize });
        if (!result.success) throw result;
        return result.data;
    }

    const query = useQuery({
        queryKey: ["issues", "finnaux", "inprogress", queryPageIndex, queryPageSize],
